...
<div class="hero" style="background-image:url('<%= photo . original_url %>')">
 </div>
 <div class="visible-xs listing-photos">
 <% if (photos.length > 0) { %>
                    <div class="img-holder">

                        <% photo = _.first(photos);
                        photos_rest = _.rest(photos, 1);
                        if (photo) {
                            %>
                             <ul class="thumbs list-inline">
                            <li> <a href="<%= photo.original_url %>" data-lightbox="lg_2<%= uuid %>_mobile"><img class="img-responsive"
                                                                                                    src="<%= photo.original_url %>"/></a></li>

                           
                                <% _.each(photos_rest, function (photo) { %>
                                    <li><a href="<%= photo.original_url %>" data-lightbox="lg_2<%= uuid %>_mobile"><img
...
<div class="details">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 col-lg-offset-0 col-md-offset-1 listing-details">
 ...
 <ul class="list-inline">
                 ...
                 <div class="visible-sm visible-md listing-photos">
 <% if (photos.length > 0) { %>
                    <div class="img-holder">
                        ...
                        if (photo) {
                            %>
                            <a href="<%= photo.original_url %>" data-lightbox="lg_1<%= uuid %>_mobile"><img class="img-responsive"
                                                                                                    src="<%= photo.original_url %>"/></a>

                            <ul class="thumbs list-inline hidden-xs">
                                <% _.each(photos_rest, function (photo) { %>
                                    <li><a href="<%= photo.original_url %>" data-lightbox="lg_1<%= uuid %>_mobile"><img
                                                class="img-responsive" src="<%= photo.original_url %>"/></a></li>
                                <% }) %>
                            </ul>
                        <% } %>
...
<div class="spacer-15" style="clear:both"></div>
            ...
            <div class="col-lg-5 visible-lg listing-photos">
 <% if (photos.length > 0) { %>
                    <div class="img-holder">
                        ...
                        if (photo) {
                            %>
                            <a href="<%= photo.original_url %>" data-lightbox="lg_<%= uuid %>_mobile"><img class="img-responsive"
                                                                                                    src="<%= photo.original_url %>"/></a>

                            <ul class="thumbs list-inline hidden-xs">
                                <% _.each(photos_rest, function (photo) { %>
                                    <li><a href="<%= photo.original_url %>" data-lightbox="lg_<%= uuid %>_mobile"><img
                                                class="img-responsive" src="<%= photo.original_url %>"/></a></li>
                                <% }) %>
                            </ul>
                        <% } %>
            ...
            <div class="col-lg-5 col-md-10 col-lg-offset-0 col-md-offset-1">
                <div class="reserve">
                    <h3>Reservation</h3>
