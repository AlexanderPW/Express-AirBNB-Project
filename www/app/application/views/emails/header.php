    ...
    <tr>
      <td width="100%" align="center">
        <table cellpadding="0" border="0"
          ...
          <tr>
            <td align="left">
              <a href="' . $signin_url . '"><img src="' . site_url('/assets/images/logo.png') . '" width="225" height="90"/></a>
            </td>
          </tr>
        </table>
      </td>
            ...
            <table cellpadding="0" border="0"
                ...
                <tr>
                    <td>
                        ...
                        <table cellpadding="0" border="0"
                               style="border-bottom: 1px solid #ebebeb; background-color: #fff; line-height: 1.2em; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; border-spacing: 0; font-size: 100%; width: 780px;  min-width: 780px;padding: 15px 0 30px;border-radius: 5px;"
                               cellspacing="0">
                            <tbody>
                            <tr valign="top" align="center">
                                <td>
                                    <table cellpadding="0" border="0"
                                           style="background-color: #fff; line-height: 1.2em; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; border-spacing: 0; font-size: 100%; max-width: 780px; min-width: 780px;"
                                           cellspacing="0">
                                        <tbody>
                                        <tr valign="top">
                                            <td style="min-width: 640px; padding: 0; color: #585a5e; line-height: 24px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; border-spacing: 0; text-align: left;">
