SubmarketView = BaseFormView.extend({

    id: 'submarket',

    template_name: 'admin/submarket',

    events: {
        "click #delete_modal1 .btn-delete-confirm" : "delete_permanently",
    ...
    delete_permanently : function(event) {
        var me = this;
        $.post( app.rest_root+'admin/cities/sub_delete', {
            uuid: this.model.id
        }, function(response) {
